...
pros::MotorGroup left_mg({10, 9}); // Creates a motor group with forwards ports 1 & 3 and reversed port 2
pros::MotorGroup right_mg({-8, -7});	// Creates a motor group with forwards port 5 and reversed ports 4 & 6
Motor armR(14);
Motor armL(13);
Motor intake (11);
Motor conveyer (6);
